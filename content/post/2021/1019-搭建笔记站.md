...
这次是用[Docsify](https://docsify.js.org/)搭的一个[笔记站](https://doc.mantyke.icu/#/)，其实它是拿来做产品文档的，但之前看到有人拿来搭了[前端学习笔记](https://docs.mphy.top/)，觉得也太好用了。不仅支持Markdown的强调语法和提示语法，还自带一个全文搜索。由于是根据md进行渲染生成，写起来也很方便，和如今流行的各种基于md的笔记软件都能做很好的配合。
...
Markdown扩展：[Ruby标签拓展](https://github.com/journey-ad/MDRuby-Typecho-Plugin)
